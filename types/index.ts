...
export type Client = { id?: string; name: string; company: string; email: string; phone: string; sector: string; module: string; status: string; mrr: number; notes: string; created_at?: string; };

...
const INTEGRATIONS = [
  { name: "Anthropic Claude API", desc: "Motor de IA para todos los módulos", key: "ANTHROPIC_API_KEY", url: "https://console.anthropic.com", required: true, color: "#00C8A0" },
  { name: "Supabase", desc: "Base de datos y autenticación", key: "NEXT_PUBLIC_SUPABASE_URL", url: "https://supabase.com/dashboard", required: true, color: "#2A5FD4" },
  { name: "Resend", desc: "Entío de emails transaccionales", key: "RESEND_API_KEY", url: "https://resend.com/api-keys", required: false, color: "#7060D8" },
  { name: "360Dialog (WhatsApp)", desc: "APM oficial de WhatsApp Business", key: "DIALOG360_API_KEY", url: "https://app.360dialog.com", required: false, color: "#25D366" },
  { name: "Recall.ai", desc: "Grabación reuniones online", key: "RECALL_AI_API_KEY", url: "https://www.recall.ai/dashboard", required: false, color: "#E05040" },
  { name: "Google Maps API", desc: "Datos de negocios para el scraper", key: "GOOGLE_MAPS_API_KEY", url: "https://console.cloud.google.com", required: false, color: "#D4A020" },
];

export default function SettingsPage() {
  const [saved, setSaved] = useState(false);
  const [brand, setBrand] = useState({ name: "Tryvor", email: "info@tryvor.com", phone: "+34 928 07 96 04", whatsapp: "+34 645 08 10 15", address: "Parque Empresarial Melenara, Telde, Las Palmas" });
            ...
            <div key={int.name} className="flex items-center gap-4 bg-[#1E2035] rounded-lg p-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {int.required && <span className="text-[10px] bg-[#E05040]/20 text-[#E05040] px-1.5 py-0.5 rounded font-semibold">REQUERIDA</span>}
                </div>

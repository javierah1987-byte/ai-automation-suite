...
const BUSINESS_DATA: Record<string, any[]> = {
  "hosteleria-las-palmas": [
    ...
    { name: "Restaurante El Herreno", address: "C/ Mendizabal 5, Las Palmas", phone: "+34 928 310 513", website: "elherreno.es", rating: 4.7, reviews: 1247 },
    ...
    { name: "Restaurante Amaiur", address: "C/ Perez Galdos 2", phone: "+34 928 370 717", website: "", rating: 4.6, reviews: 634 },
    { name: "El Churrasco Las Palmas", address: "C/ Remedios 3", phone: "+34 928 311 400", website: "", rating: 4.4, reviews: 567 },
    { name: "Restaurante Cho Zacarias", address: "Av. Mesa y Lopez 45", phone: "+34 928 265 412", website: "", rating: 4.5, reviews: 423 },
    { name: "Bar Restaurante Chapin", address: "C/ Travieso 8", phone: "+34 928 364 054", website: "", rating: 4.3, reviews: 312 },
  ],
  "hosteleria-sur": [
    { name: "El Palmeral Playa del Ingles", address: "C.C. Faro 2, Playa del Ingles", phone: "+34 928 762 310", website: "elpalmeral.com", rating: 4.5, reviews: 2156 },
    ...
    { name: "Restaurante Pergola", address: "CC San Agustin", phone: "+34 928 769 420", website: "", rating: 4.6, reviews: 756 },
  ],
  "hosteleria-lanzarote": [
    { name: "La Tegala", address: "C/ Macher 12, Tinajo, Lanzarote", phone: "+34 928 524 324", website: "lategala.com", rating: 4.9, reviews: 3421 },
  ...
  "salud-las-palmas": [
    { name: "Clinica Dental Smile Las Palmas", address: "C/ Triana 78, Las Palmas", phone: "+34 928 362 100", website: "smilecanarias.es", rating: 4.8, reviews: 432 },
    { name: "Centro Psicologia Bienestar", address: "Av. Juan XXIII 14", phone: "+34 928 365 412", website: "", rating: 4.9, reviews: 234 },
    { name: "Fisioterapia Sport Canarias", address: "C/ Perojo 23, Las Palmas", phone: "+34 928 480 213", website: "", rating: 4.7, reviews: 312 },
    { name: "Clinica Dental Estetic", address: "C/ Leon y Castillo 320", phone: "+34 928 278 900", website: "clinicaestetic.es", rating: 4.6, reviews: 523 },
    { name: "Centro Medico Las Palmas", address: "Av. Mesa y Lopez 45", phone: "+34 928 247 700", website: "centromedicolp.es", rating: 4.5, reviews: 867 },
  ],
  "inmobiliaria-las-palmas": [
    { name: "RE/MAX Canarias", address: "C/ Veintium de Agosto 17, Las Palmas", phone: "+34 928 497 800", website: "remaxcanarias.com", rating: 4.7, reviews: 456 },
    { name: "Century 21 Las Palmas", address: "Av. Mesa y Lopez 12", phone: "+34 928 293 080", website: "century21lp.es", rating: 4.6, reviews: 312 },
  ],
  ...
  "educacion-las-palmas": [
    ...
    { name: "Centro de Idiomas Canarias", address: "Av. Mesa y Lopez 23", phone: "+34 928 264 700", website: "idiomascn.es", rating: 4.5, reviews: 234 },
  ],
  "belleza-las-palmas": [
    ...
    { name: "Clinica Estetica Belleza Total", address: "Av. Juan XXIII 8", phone: "+34 928 368 432", website: "bellezatotal.es", rating: 4.6, reviews: 189 },
  ],
...
export async function POST(req: NextRequest) {
  try {
    ...
    const allLeads = BUSINESS_DATA[key] || BUSINESS_DATAY"{osteleria-las-palmas"];
    ...
    const leadsText = leads.map((l, i) =>
      `${i+1}. ${l.name} | Rating: ${l.rating} | Reviews: ${l.reviews} | Web: ${l.website ? "yes" : "no"}`
    ).join("\n");
    ...
    const scoreRes = await anthropic.messages.create({
      ...
      messages: [{
        role: "user",
        content: `Evaluate these ${leads.length} businesses in sector "${sector}" zone "${zone}" for AI automation potential. Score 1-10. Reply ONLY with JSON array: [8,7,...]\n${leadsText}`
      }]
    });
    ...
    const scoredLeads = leads.map((l, i) => ({
      ...l,
      score: scores[i] || Math.floor(6 + Math.random() * 4),
      zone,
      sector,
      status: "new",
